...
from layer_utils.psroi_pooling.modules.psroi_pool import PSRoIPool
...
class Network(nn.Module):
    ...
    def _region_classification(self, feature, rois):

        rfcn_score_map = self.rfcn_score_net(feature)
    ...
    def _predict(self):
        ...
        cls_prob, bbox_pred = self._region_classification(net_conv, rois)
    ...
    def init_weights(self):
        ...
        normal_init(self.rfcn_score_net, 0, 0.01, cfg.TRAIN.TRUNCATED)
        normal_init(self.rfcn_bbox_net, 0, 0.001, cfg.TRAIN.TRUNCATED)
